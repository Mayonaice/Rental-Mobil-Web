...
@section('content')
    ...
    <h1 class="text-4xl font-bold text-purple-600 max-w-md mx-auto mb-4">Edit Mobil</h1>
    ...
    <div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-lg">
        ...
        <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input value="{{ $product->nama_mobil }}" type="text" id="name" name="nama_mobil"
            ...
            <div class="mb-4">
                ...
                <input value="{{ $product->tahun }}" type="number" name="tahun"
                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            ...
            <div class="mb-4">
                ...
                <input value="{{ $product->harga_sewa }}" type="number" name="harga_sewa"
                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
