                ...
                <div
                    ...
                    <div class="px-9 pt-5 flex justify-between items-stretch flex-wrap min-h-[70px] pb-0 bg-transparent">
                        <h3 class="flex flex-col items-start justify-center m-2 ml-0 font-medium text-xl/tight text-dark">
                            <span class="mr-3 font-semibold text-dark">List Mobil</span>
                        </h3>
                                ...
                                <table class="w-full my-0 align-middle text-dark border-neutral-200">
                                    <thead class="align-bottom">
                                        <tr class="font-semibold sm:text-[0.7rem] lg:text-[0.95rem]  text-secondary-dark">
                                            <th class="pb-3 text-center ">Gambar</th>
                                            <th class="pb-3 text-center ">Nama</th>
                                            <th class="pb-3 text-center ">Kategori</th>
                                            <th class="pb-3 text-center ">Tahun</th>
                                            <th class="pb-3 text-center sm:text-[0.7rem] lg:text-base">Harga Sewa</th>
                                    ...
                                    <tbody>
                                        <tr class="border-b border-dashed last:border-b-0">
                                                ...
                                                <div class="flex">
                                                    <div class="content-center flex rounded-2xl">
                                                        <img src="{{ asset('storage/' . $product->image) }}"
                                                            class=" lg:w-[160px] lg:h-[100px] sm:w-[60px] sm:h-[40px] rounded-2xl"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="p-3 pr-0 text-center">
                                                <span
                                                    class="font-semibold text-light-inverse sm:text-[0.8rem] lg:text-[1.2rem] text-md/normal">{{ $product->nama_mobil }}</span>
                                            </td>
                                            <td class="p-3 pr-0 text-center">
                                                <span
                                                    class="font-semibold text-light-inverse sm:text-[0.8rem] lg:text-[1.2rem] text-md/normal">{{ $product->category->name }}</span>
                                            </td>
                                            <td class="p-3 pr-0 text-center">
                                                <span
                                                    class="font-semibold text-light-inverse sm:text-[0.8rem] lg:text-[1.2rem] text-md/normal">{{ $product->tahun }}</span>
                                            </td>
                                            <td class="p-3 pr-0 text-center">
                                                <span
                                                    class="font-semibold text-light-inverse sm:text-[0.8rem] lg:text-[1.2rem] text-md/normal">${{ $product->harga_sewa }}</span>
                                            </td>
                                            <td class="ps-16">
